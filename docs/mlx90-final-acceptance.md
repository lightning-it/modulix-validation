...
`sha256:98f1430988e4e29721819212cb8a63cfe87d8abc3688562145788ad4cd07bf8c`
...
test -f "$script"
test ! -L "$script"
test "$(sha256sum "$script" | cut -d' ' -f1)" = "98f1430988e4e29721819212cb8a63cfe87d8abc3688562145788ad4cd07bf8c"
exec python3 "$script"
```
